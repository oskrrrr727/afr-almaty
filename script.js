...
const T = {
  ...
  kk: {
    ...
    hero_subtitle: "Шевченко көшесіндегі «Молодёжный» кешенінің премиум-пәтерлері. Мінсіз тазалық, тәулік бойы орналастырамыз, WhatsApp арқылы бір минутта брондайсыз.",
    ...
    adv_eyebrow: "Бізді неге таңдайды", adv_title: "Жайлы тұруға қажеттің бәрі бар",
    feat1_t: "Таза пәтерлер", feat1_d: "Әр қонақтың алдында жалпы тазалық және таза төсек-орын.",
    feat2_t: "10–15 минутта орналасу", feat2_d: "Күттірмей орналастырамыз — түн ортасы болса да, тәулік бойы.",
    feat3_t: "Құпиялылық", feat3_d: "Толық жеке кеңістік, орналасқанда артық сұрақ қоймаймыз.",
    feat4_t: "Тұрмысқа қажеттің бәрі", feat4_d: "Wi-Fi, тұрмыстық техника, ыдыс, тазалық құралдары мен сүлгі — бәрі дайын.",
    feat5_t: "Премиум орналасу", feat5_d: "Шевченкодағы «Молодёжный» кешені — қала орталығы мен басты нысандарға жақын.",
    feat6_t: "Шарт пен чек", feat6_d: "Ресми түрде рәсімдейміз, сұрасаңыз фискалдық чек береміз.",
    ...
    tar_eyebrow: "Бағалар", tar_title: "Артық төлемсіз әділ баға", tar_lead: "Сағаттап, күндізгі, түнгі немесе тәуліктік жалдау. Төменде — толық баға тізімі.",
    tar1_name: "Сағаттап", tar1_desc: "Кездесуге, демалуға және қысқа сапарға.", tar1_price: "6 000 ₸-ден<span>/ 2 сағат</span>",
    tar1_li1: "Кемінде 2 сағат", tar1_li2: "Сүлгі мен таза төсек-орын", tar1_li3: "Wi-Fi және техника", tar1_li4: "Толық құпиялылық",
    tar_badge: "Танымал",
    tar2_name: "Күндіз не түн", tar2_desc: "Күндіз жайлы демалу немесе түнеп шығу.", tar2_price: "15 000 ₸-ден<span>/ күн · түн</span>",
    tar2_li1: "Күндіз не түн — таңдауыңыз", tar2_li2: "10–15 минутта орналасу", tar2_li3: "Тұруға қажеттің бәрі", tar2_li4: "Сұрасаңыз — шарт пен чек",
    tar3_name: "Тәулік", tar3_desc: "Сапар мен демалысқа толық 24 сағат.", tar3_price: "25 000 ₸-ден<span>/ тәулік</span>",
    tar3_li1: "Толық тәулік — 24 сағат", tar3_li2: "Ұзақ мерзімге жеңілдік", tar3_li3: "Кірер алдында тазалау", tar3_li4: "Тәулік бойы орналасу",
    ...
    rev1_text: "«Түнгі рейспен келдім, түнгі сағат үште артық сұрақсыз орналастырды. Пәтер суреттегідей — таза, жылы әрі жайлы. WhatsApp-та лезде жауап берді.»", rev1_role: "Тәулікке · 2 апта бұрын",
    ...
    rev3_text: "«Мерейтойға романтикалық безендірумен пәтер брондадық — шам, шар, бәрі айтқанымыздай. Әдемі әрі сыпайы жасады. Рахмет!»", rev3_role: "Безендіру · 3 апта бұрын",
    ...
    nav_rules: "Ережелер",
    rules_eyebrow: "Ережелер", rules_title: "Тұру ережелері", rules_lead: "Ең қажетті бірнеше ереже — демалысыңыз тегіс өтуі үшін.",
    rule1_t: "Құжат қажет", rule1_d: "Орналасқанда жеке куәлік не паспорт көрсетесіз.",
    rule2_t: "Қайтарымды кепілақы", rule2_d: "Кірерде шағын кепілақы аламыз — бәрі бүтін болса, шығарда толық қайтарамыз.",
    rule3_t: "Темекі шегуге болмайды", rule3_d: "Пәтер ішінде темекі, кальян және вейпке тыйым салынған.",
    rule4_t: "Шулы кеш өткізуге болмайды", rule4_d: "23:00-ден 08:00-ге дейін тыныштық сақталады — көршілерді сыйлаймыз.",
    rule5_t: "Мүлікке ұқыпты болыңыз", rule5_d: "Бүлінген заттың құны келісім бойынша өтеледі.",
    rule6_t: "Қонақ саны", rule6_d: "Пәтерге тек брондау кезінде айтылған қонақтар кіреді.",
    rules_note: 'Толық ережелер — <a href="https://instagram.com/afr_inalmaty" target="_blank" rel="noopener">Instagram</a> парақшамыздағы ережелер бөлімінде.',
    map_2gis: "2ГИС-те ашу", map_google: "Google Maps-те ашу", map_google_short: "Google Maps",
    loc_eyebrow: "Орналасу", loc_title: "Алматы, Шевченко к-сі, 85", loc_lead: "«Молодёжный» кешені — қала орталығында, метро мен сауда орталықтарына жақын.",
    cta_title: "Кіруге дайынсыз ба?", cta_text: "Бізге жазыңыз — күндеріңіз бен бюджетіңізге сай пәтерді бірер минутта табамыз.", cta_btn: "WhatsApp-қа жазу",
